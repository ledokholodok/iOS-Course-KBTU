 ...
 */
var ledokholodok = User(name: "Lidiya", age: 21, height: 170.0, weight: 60.0, activityLevel: 5)
print(ledokholodok.name, ledokholodok.age, ledokholodok.height, ledokholodok.weight, ledokholodok.activityLevel)
/*:
