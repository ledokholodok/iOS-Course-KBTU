 ...
 */
var favoriteBook = Book(title: "Can't Wait to Get to Heaven", author: "Fanny Flagg", pages: 365, price: 14.99)
print(favoriteBook.title)
print("Author: \(favoriteBook.author), pages: \(favoriteBook.pages), price: \(favoriteBook.price)")
