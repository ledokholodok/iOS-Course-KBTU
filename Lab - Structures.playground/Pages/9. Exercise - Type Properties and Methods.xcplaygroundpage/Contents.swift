...
struct User {
    ...
    var email: String
    var age: Int
    static var currentUser = User(userName: "ledokholodok", email: "lidiya.karn@gmail.com", age: 21)
 ...
 */
let newUser = User(userName: "potato", email: "potato1234@gmail.com", age: 50)
