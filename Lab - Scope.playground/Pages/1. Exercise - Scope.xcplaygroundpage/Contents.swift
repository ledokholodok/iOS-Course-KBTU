...
// Because the constant foo id declared in the for loop(local constant)
/*:
...
//Because the variable x is declared globally, so it can be modified everywhere. x is defined in the global scope, modified in the local scope
//foo is defined and used in local scope
/*:
...
greeting(greeting: "Hi there", name: "Lidiya")
greeting(greeting: nil, name: "Lidiya")
/*:
