 ...
 */
//falcon is an object of the Spaceship class. And weapon is a field of the Fighter class,
//there is no such field for the Spaceship class. So we can't print it.
/*:
