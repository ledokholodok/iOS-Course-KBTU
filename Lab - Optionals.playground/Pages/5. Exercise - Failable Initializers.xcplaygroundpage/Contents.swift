 ...
 */
let firstComputer: Computer? = Computer(ram: 2, yearManufactured: 1990)
let secondComputer: Computer? = nil

if let computer1 = firstComputer {
    print(computer1.ram, computer1.yearManufactured)
}

if let computer2 = secondComputer {
