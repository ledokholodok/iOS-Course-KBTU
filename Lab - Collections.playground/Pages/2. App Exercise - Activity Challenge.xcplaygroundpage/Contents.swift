 ...
 */
var walkingChallengesList: [String] = ["Walk 3 miles a day", "Walk 5 miles a day"]
var runningChallengesList: [String] = ["Run 5 times a week", "Run 3 times a week"]
/*:
 ...
 */
var challanges = [walkingChallengesList, runningChallengesList]
 ...
 */
var commitesChallenges: [String] = []
/*:
 Write an if statement that will use `isEmpty` to check if there is anything in the array. If there is not, print a statement asking the user to commit to a challenge. Add an else-if statement that will print "The challenge you have chosen is <INSERT CHOSEN CHALLENGE>" if the array count is exactly 1. Then add an else statement that will print "You have chosen multiple challenges."
 */
if commitesChallenges.isEmpty {
    print("Choose a challenge.")
} else if commitesChallenges.count == 1 {
    print("The challenge you have chosen is \(commitesChallenges[0]).")
} else {
