...
func add(firstNumber: Int?, secondNumber: Int?) -> Int? {
    guard firstNumber != nil  && secondNumber != nil else {
        return nil
    }
...
add(firstNumber: nil, secondNumber: 3)
/*:
...
func createUser() -> User? {
    guard firstNameTextField.text !=  "" && lastNameTextField.text != "" && ageTextField.text != "" else {
        return nil
    }
